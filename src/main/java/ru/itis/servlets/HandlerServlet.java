...
import ru.itis.helpers.JsonHelper;
...
public class HandlerServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		URL getUrl = new URL("https://api.openweathermap.org/data/2.5/weather?q=" + jsonMap.get("city") + "&appid=f51d36062adebca914280d85b3b10d36");
